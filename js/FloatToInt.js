// ComfyUI - CRZ Float to Int JS Extension
import { app } from "../../scripts/app.js";

app.registerExtension({
    name: "CRZ.FloatToInt",
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData.name === "CRZFloatToInt") {
            ...
            nodeType.prototype.onNodeCreated = function () {
                ...
                this.bgcolor = "rgba(48, 48, 48, 0.829)";
                ...
                if (this.inputs && this.inputs[0]) {
                    ...
                    this.inputs[0].color_off = "rgba(63, 126, 79, 1)";
                    this.inputs[0].color_on = "rgba(94, 238, 125, 1)";
                }
                if (this.outputs && this.outputs[0]) {
                    this.outputs[0].localized_name = " ";
                    this.outputs[0].color_off = "rgba(38, 78, 116, 1)";
                    this.outputs[0].color_on = "rgba(69, 147, 219, 1)";
                }
